                ...
                <div class="overflow-hidden shadow-sm ring-1 ring-black ring-opacity-5 rounded-lg">
                  ...
                  <div class="mb-6 p-4 rounded-lg shadow-sm">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                      ...
                      <div class="md:col-span-4 flex justify-end space-x-2 mt-2">
                        <button @click="fetchAuditLogs()" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700"> Apply </button>
                  ...
                  <div class="mt-6 flex items-center justify-between">
                    ...
                    <nav class="inline-flex rounded-md shadow-sm isolate" aria-label="Pagination">
                      <button @click="fetchAuditLogs(pagination.current_page - 1)" :disabled="pagination.current_page === 1" class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-l-md hover:bg-gray-50 disabled:opacity-50"> ‹ Prev </button>
                      <template v-for="page in visiblePages" :key="page">
                        <button @click="fetchAuditLogs(page)" :class="[
                      ...
                      <button @click="fetchAuditLogs(pagination.current_page + 1)" :disabled="pagination.current_page === pagination.last_page" class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-r-md hover:bg-gray-50 disabled:opacity-50"> Next › </button>
                    </nav>
                  </div>
                </div>
              </div>
