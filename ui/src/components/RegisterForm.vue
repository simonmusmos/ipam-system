  ...
  <div class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg">
    ...
    <form @submit="onSubmit" class="space-y-6">
      <div>
        ...
        />
        <span v-if="meta.touched.name && errors.name" class="mt-1 text-red-500 text-sm block">{{ errors.name }}</span>
      </div>
      ...
      <div>
        ...
        />
        <span v-if="meta.touched.confirmPassword && errors.confirmPassword" class="mt-1 text-red-500 text-sm block">{{ errors.confirmPassword }}</span>
      </div>
